...
const ReviewHome = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between px-4 sm:px-28 gap-16 py-16 sm:py-16">
      ...
      <div className="ratingRightContent flex flex-col gap-8 w-auto text-left justify-center px-2 sm:pl-12">
        <h1 className="text-3xl sm:text-4xl font-semibold">Culture <span className="font-bold text-red-700">crafted</span>  and <span className="font-bold text-red-700"> loved</span> by engineers</h1>
        <p className="sm:text-base font-extralight">
          The Simform culture is crafted to create a truly rewarding experience
          for engineers, <span className="font-medium"> meaning your team will be made up of highly motivated
          people. </span> As a result our teams are tightly integrated with yours. And
          that is shown by the love they shower back on us.
        </p>
        <HoverBorderGradient
