import ContentImage from "../../public/demo.png";

export const industryData = {
  healthcare: {
    title: "Healthcare",
    heading: "Revolutionizing Patient Care and Operations",
    description: `
      Our healthcare solutions are tailored to enhance patient care, optimize operational efficiency, and support healthcare professionals in delivering high-quality services. We leverage the latest technologies to create innovative systems that streamline workflows, improve patient outcomes, and ensure compliance with industry standards. Our offerings include:
    `,
    offerings: [
      {
  ...
  education: {
    title: "Education",
    heading: "Empowering the Future of Learning",
    description: `
      Our education solutions are designed to create engaging learning environments, streamline administrative tasks, and foster innovation in the classroom. By integrating cutting-edge technologies, we empower educators to deliver personalized learning experiences, while also improving institutional efficiency and student outcomes. Our offerings include:
    `,
    offerings: [
      {
  ...
  hospitality: {
    ...
    heading: "Enhancing Guest Experiences",
    description: `
      In the hospitality and tourism industry, our solutions focus on enhancing guest satisfaction, streamlining operations, and supporting staff. We offer advanced technologies that help businesses provide personalized services, improve operational efficiency, and create memorable guest experiences. Our tailored solutions meet the dynamic needs of this industry. Our offerings include:
    `,
    offerings: [
      {
  ...
  ecommerce: {
    title: "E-Commerce",
    heading: "Transforming Online Retail",
    description: `
      Our e-commerce solutions are designed to enhance online shopping experiences, streamline operations, and increase sales. We provide innovative technologies that help businesses thrive in the digital marketplace by offering seamless, secure, and user-friendly platforms that meet the evolving demands of consumers. Our offerings include:
    `,
    offerings: [
      {
  ...
  banking: {
    title: "Banking",
    heading: "Innovating Financial Services",
    description: `
      Our banking solutions are designed to enhance financial services, streamline operations, and ensure compliance. We provide cutting-edge technologies that help banks deliver exceptional customer experiences while maintaining security and regulatory standards. Our offerings include:
    `,
    offerings: [
      {
  ...
  fintech: {
    ...
    description: `
      In the fintech industry, our solutions are designed to foster innovation, enhance financial services, and support startups. We provide state-of-the-art technologies that help fintech companies lead the way in the digital finance revolution. Our offerings include:
    `,
    offerings: [
      {
